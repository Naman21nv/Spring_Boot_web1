 ...
 *   3. @ComponentScan: Tells Spring to look for other components, configurations, and services in the current package, allowing it to find the controllers (like your HomeController).
 *
 * <p>Execution flow:
 ...
 *    - Performs class path scanning to find components (like @Controller).
 *    - Starts the embedded web server (Tomcat) if the application is a web application.
 *
 * <p>Methods:
